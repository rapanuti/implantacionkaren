  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-primary text-center" id="edit" style="display:none;">Avatar actualizado correctamente</div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <div class='text-center mt-1'>
                  <button type='button' data-toggle="modal" data-target="#cambiophoto" class='btn btn-success btn-sm'>Cambiar avatar</button>
                </div>
