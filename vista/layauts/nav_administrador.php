...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="../administrador/adm_catalogo.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
          ...
          <li class="nav-item">
            <a href="../administrador/adm_editar_datos.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../administrador/adm_usuarios.php" class="nav-link">
...
<li class="nav-item">
    <a href="../administrador/adm_consultorios.php" class="nav-link">  <!-- NUEVO -->
        <i class="nav-icon fas fa-building"></i>
        <p>Consultorios</p>
    </a>
</li>
<li class="nav-item">
    <a href="../administrador/adm_recetas.php" class="nav-link">
